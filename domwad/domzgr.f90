...
CONTAINS       
   ...
   SUBROUTINE dom_zgr
      ...
      INTEGER ::   ios
      !
      NAMELIST/namzgr/ ln_zco, ln_zps, ln_sco, ln_mes, ln_isfcav, ln_linssh
      !!----------------------------------------------------------------------
      !
